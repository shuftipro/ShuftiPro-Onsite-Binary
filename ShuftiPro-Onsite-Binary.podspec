...
spec.name         = "ShuftiPro-Onsite-Binary"
spec.version      = "1.0.1"
...
DESC
spec.homepage     = "https://github.com/shuftipro/ShuftiPro-Onsite-Binary"
spec.license      = { :type => "MIT", :file => "LICENSE" }
spec.author       = { "Shufti Pro" => "support@shuftipro.com" }
spec.platform     = :ios, "13.0"
spec.source       = { :git => "https://github.com/shuftipro/ShuftiPro-Onsite-Binary.git", :tag => "#{spec.version}" }
